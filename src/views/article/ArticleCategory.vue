...
import {articleCategoryListService,articleCategoryAddService} from '@/api/article/article'
...
const showDialog = (row: { categoryName: string; categoryAlias: string; id:string})=>{
